            ...
            <CartContainer ref={showCartRef}>
                ...
                cart.length?
                    (<>
                                    ...
                                    return (<>
                                        <Product key={i}>
                                            <Details>
                                                ...
                                                <H4Text style={{fontWeight: 600, fontSize: 16}}>{price.currency.symbol + (product.quantity * price.amount).toFixed(2)}</H4Text>
                                                {
                                                    product.attributes?.map((attr, i) => (
                                                        <div id={attr.id} key={i}>
                                                            <H4Text style={{fontWeight: 300, fontSize: 16}}>{attr.name}: </H4Text>
                                                            <Boxes>
                                                                {
                                                                    attr.type === 'swatch'?
                                                                    attr.items.map((item, i) => (
                                                                        <ColorBox
                                                                            ...
                                                                            style={{weight:400, fontSize: 14, width: 24, height: 24, marginRight: 8}}
                                                                        />
                                                                    )):
                                                                    attr.items.map((item, i) => (
                                                                        <SizeBox
                                                                            ...
                                                                            key={i}
                                                                            onClick={e => onSelect({e, product, attr, item})}
                                                                            style={{weight:400, fontSize: 14, width: 24, height: 24, margin: '0 8px 8px 0'}}
                                                                        />
                                                                    ))
                                                                }  
                                                            </Boxes> 
                        ...
                        <InLine style={{justifyContent: 'space-between'}}>
                            <CommonButton onClick={onViewCart} style={{width: 140, height: 43, background: '#fff', border: '1px solid #1D1F22', color:' #1D1F22'}}>VIEW BAG</CommonButton>
