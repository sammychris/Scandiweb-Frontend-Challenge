...
class Card extends React.Component {
    render(){
        const {currency, addToCart, product} = this.props;
        const { id, inStock, gallery, name, prices } = product;
            ...
            <Container>
                <ProductUrl to={'/product/'+id}>
                    <ProductImg src={gallery[0]}>
                        ...
                        <AddToCartIcon onClick={(e) => addToCart(e, product)} src={addToCartIcon}/>
                    </ProductImg>
                    <Title>{name}</Title>
