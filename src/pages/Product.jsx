...
class Product extends React.Component {
    render(){
        const { loading, product, onSelect, currency, addToCart, galleryIndex, setGalleryIndex } = this.props;
            ...
            <Layout>
                <ProductContainer>
                    ...
                    <ProductDetails>
                        ...
                        <CommonButton onClick={addToCart} style={{marginBottom: 40}}>Add to Cart</CommonButton>
